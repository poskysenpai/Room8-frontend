...
const ApartmentImages2 = () => {
    ...
    return (
      <div className="px-5 space-y-3 my-5">
        <div className="font-bold text-2xl font-Oxygen leading-9">MORE APARTMENTS</div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {imgUrls.map((imgUrl, index) => (
            <ApartmentImageCard  key={index} imgUrl={imgUrl} />
          ))}
        </div>
      </div>
    );
...
export default ApartmentImages2