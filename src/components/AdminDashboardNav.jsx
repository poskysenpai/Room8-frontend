...
const AdminDashboardNav = ({ notifications = 3, initials = "SC", userName = "Samuel Carter" }) => {
  return (
    <div className='pl-6 pr-11 py-2 m-0 bg-white'>
      <div className="flex justify-end items-end">
        <div className="justify-center items-center gap-2 inline-flex">
          ...
          <p className='font-inter text-sm text-[#98A2B3] font-normal leading-5'>{userName}</p>
        </div>
      </div>
    </div>
  );
